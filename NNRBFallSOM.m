function NNRBFallSOM(varargin)%------------all_trainRBF
...
[Centerss, betass, Theta,X_activ] = trainRBFNSOM(im, labels', centersPerCategory,true);
...
%end
%save('E:\old matconvnet\rbfn_O\Data\trainRBNF1,120.mat','Centerss', 'betass', 'Theta');
save('E:\old matconvnet\rbfn_O\DataSOM\trainRBNFSOM,46.mat','Centerss', 'betass','Theta','X_activ','-v7.3');
%load('E:\old matconvnet\rbfn_O\Data\trainRBNF1,120.mat');
%--------------------------------------extract test features(X_activ)
%NNRBFallTf();

%--------------------------------------------%Test
%load('E:\old matconvnet\rbfn_O\DataSOM\trainRBNFSOM,46.mat');
 load('E:\Matlab\Testall7\im1');%%%%%%%%%%%%%%%%%% 1dim  for Test
%  load('E:\old matconvnet\rbfn_O\Data\trainRBNF1,120.mat');%%%%%%%%%%%%%%%%%%for Test
...
% save('E:\old matconvnet\confusionSOM\RBFSOM\pr1.mat','pred');
% save('E:\old matconvnet\confusionSOM\RBFSOM\gt1.mat','ground');
...
%--------------------------------------
gt1 = zeros(20,length(gt),'double') ;
p1 = zeros(20,length(gt),'double') ;
