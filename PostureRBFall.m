function PostureRBFall(varargin)%------------all_trainRBF
...
load('E:\Matlab\PostureGesture\Trainfeature.mat');%%%%%%%%%%%%%%%%%% 1dim
im=im';
labels=label;
...
tic
[Centerss, betass, Theta,X_activ] = PostureRBFN(im, labels', centersPerCategory,true);
%[Centerss, betass, Theta,X_activ] = PostureRBFNSOM(im, labels', centersPerCategory,true);
toc
...
% 
% end
% save('E:\old matconvnet\rbfn_O\Data\PstureRBNF1,50.mat','Centerss', 'betass', 'Theta');
% save('E:\old matconvnet\rbfn_O\Data\PostureRBNFSOM,6.mat','Centerss', 'betass', 'Theta','-v7.3');
% 
...
load('E:\Matlab\PostureGesture\Testfeature');%%%%%%%%%%%%%%%%%% 1dim  for Test
%  %load('E:\old matconvnet\rbfn_O\Data\LeaptrainRBNF1,50.mat');%%%%%%%%%%%%%%%%%%for Test
%  load('E:\old matconvnet\rbfn_O\Data\PostureRBNFSOM,4.mat');%%%%%%%%%%%%%%%%%%for Test
im=im';
...
%mAp(ground,pred);
ROC(ground,pred);
save('E:\old matconvnet\confusionRBF\PostureSOM,2,pr1.mat','pred');
save('E:\old matconvnet\confusionRBF\PostureSOM,2,gt1.mat','ground');
