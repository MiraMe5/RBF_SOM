function [Centers, betas, Theta,X_activ] = PostureRBFN(X_train, y_train, centersPerCategory, verbose)%,X_activ add
...
for (c = 1 : numCats)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% for 0.5
    centersPerCategory=round(size(Xc,1)/20);%100
    ...
    [Centroids_c, memberships_c] = kMeans(Xc, init_Centroids, 10000);
